...
$command = 'python -m PyInstaller .\main.py -F --name InventorySystem --clean --add-data ".\callUpdate.ps1;.\" --add-data "S:\Documents\InventorySystemCredentials\credentials.json;.\" --distpath "..\"'
